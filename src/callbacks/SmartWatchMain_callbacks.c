...
extern char hg_time_label_1768896234329_v8yi_time_str[10];
...
void hg_arc_1768184103087_n36y_switch_view_cb(void *obj, gui_event_t *e)
{
    GUI_UNUSED(obj);
    GUI_UNUSED(e);
    gui_view_switch_direct(gui_view_get_current(), "app_battery_view", SWITCH_OUT_TO_BOTTOM_USE_TRANSLATION, SWITCH_IN_ANIMATION_FADE);
}
...
void hg_time_label_1768896234329_v8yi_time_update_cb(void *p)
{
    GUI_UNUSED(p);
    ...
    // 更新时间字符串
    sprintf(hg_time_label_1768896234329_v8yi_time_str, "%02d:%02d", t->tm_hour, t->tm_min);
    
    // 更新小时组件（前2个字符）
    if (hg_time_label_1768896234329_v8yi_hour) {
        gui_text_content_set(hg_time_label_1768896234329_v8yi_hour, hg_time_label_1768896234329_v8yi_time_str, 2);
    }
    
    // 更新分钟组件（后2个字符，跳过冒号）
    if (hg_time_label_1768896234329_v8yi_min) {
        gui_text_content_set(hg_time_label_1768896234329_v8yi_min, hg_time_label_1768896234329_v8yi_time_str + 3, 2);
    }
}
